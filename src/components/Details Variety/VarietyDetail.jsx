...
const VarietyDetail = () => {
  ...
  useEffect(() => {
    const fetchVariety = async () => {
      try {
        const res = await fetch(
          `https://maltamart-backend.vercel.app/varieties/${id}`,
        );
    ...
    const checkFavourite = async () => {
      try {
        ...
        const res = await fetch(
          "https://maltamart-backend.vercel.app/favourites",
          {
  ...
  const toggleFavourite = async () => {
    ...
    try {
      if (!isFavourite) {
        const res = await fetch(
          `https://maltamart-backend.vercel.app/favourites/add/${id}`,
          {
            method: "POST",
            headers: {
  ...
  const specs = [
    ...
    },
    {
      ...
      label: "Storage Temp",
      value: "2–8°C for Transit",
    },
    {
      icon: <FaWeightHanging />,
      label: "Avg Fruit Weight",
      value: "140–220 grams",
    },
  ...
  const packagesAndLogistics = [
    {
      ...
      desc: "Rigid corrugated boxes with custom brand printing",
    },
    {
      icon: <FaBoxes />,
      label: "Palletized Cartons",
      desc: "Fumigated wooden pallets ready for sea/EU containers",
    },
    {
      icon: <FaTruck />,
      label: "Reefer Containers",
      desc: "Strictly monitored cold chain storage (2-8°C)",
    },
    {
      icon: <FaShieldAlt />,
      label: "Secure Transit",
      desc: "Full container stuffing supervision and export insurance",
    },
  ];
  ...
  const compliance = [
    {
      ...
      desc: "Verified plant health clearance docs",
    },
    {
      icon: <FaGlobe />,
      label: "Global GAP Compliant",
      desc: "Good Agricultural Practices standard audit",
    },
    {
      icon: <FaWarehouse />,
      label: "ISO Packing House",
      desc: "Processed in certified packing houses",
    },
    {
      icon: <FaMosque />,
      label: "Halal Processing",
      desc: "Compliance under strict sanitary standards",
    },
    {
      icon: <FaCheckCircle />,
      label: "100% Fresh Harvest",
      desc: "Harvested only after orders are locked",
    },
    {
      icon: <FaShieldAlt />,
      label: "Pre-Shipment Check",
      desc: "Third-party quality verification before sailing",
    },
  ];
      ...
      <div className="detail-page">
        <section className="section-one section-animate">
          ...
          <div className="right">
            ...
            <div className="orange-buttons">
              ...
              <button
                className={`btn-outline ${isFavourite ? "active-fav" : ""}`}
        ...
        <section className="detail-section section-animate">
          <div className="detail-section-header">
            <h2>
              <FaInfoCircle /> Crop Specifications
            </h2>
            <p>
              Verified physical and nutritional metrics of this citrus breed.
            </p>
          </div>
        ...
        <section className="detail-section section-animate">
          <div className="detail-section-header">
            <h2>
              <FaBoxOpen /> Packaging & Shipping
            </h2>
            <p>
              Global export-grade custom packing and temperature-controlled
              logistics.
            </p>
          </div>
          <div className="detail-cards-grid">
        ...
        <section className="detail-section section-animate">
          <div className="detail-section-header">
            <h2>
              <FaCheckCircle /> Quality & Certifications
            </h2>
            <p>
              International compliance audit, phytosanitary checks, and farm
              guarantees.
            </p>
          </div>
          <div className="detail-cards-grid">
