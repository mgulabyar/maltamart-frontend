  ...
  const handleLogout = async () => {
    try {
      const res = await fetch(
        "https://maltamart-backend.vercel.app/auth/logout",
        {
          method: "DELETE",
  ...
  return (
    <>
      <nav className="navbar">
        ...
        {!hideCenter && (
          <div className="nav-center">
            <button
              className={getActiveCls("/home")}
              onClick={() => navigate("/home")}
            >
              Home
            </button>
            <button
              className={getActiveCls("/view-varieties")}
              onClick={() => navigate("/view-varieties")}
            >
              View Varieties
            </button>
            <button
              className={getActiveCls("/about")}
              onClick={() => navigate("/about")}
            >
              About
            </button>
            <button
              className={getActiveCls("/favourite")}
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        {role === "admin" && (
          <button
            className={getActiveCls("/create-variety")}
