      ...
      <div className="contact-section">
        ...
        <div className="contact-details" ref={detailsRef}>
          <div>
            ...
            <a href="tel:+1234567890">+92 346 801 692 1</a>
          </div>

          <div>
            <FaEnvelope className="contact-icon" />
            <a href="mailto:expert@maltaexport.com">expert@maltaexport.com</a>
          </div>
          ...
          <div className="contact-buttons">
            ...
            <a href="mailto:expert@maltaexport.com" className="btn-email">
              Email Expert
            </a>
          </div>
        </div>
