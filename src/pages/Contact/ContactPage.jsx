    ...
    <>
      <div className="contact-page">
        <div className="contact-header">
          ...
          <p>
            Reach out to our export specialist for any queries or export
            guidance.
          </p>
        </div>
        ...
        <div className="contact-section">
          ...
          <div className="contact-details" ref={detailsRef}>
            ...
            <div>
              ...
              <a href="mailto:shabanaishaq.work@gmail.com">
                shabanaishaq.work@gmail.com
              </a>
            </div>
            ...
            <div className="contact-buttons">
              ...
              <a
                href="mailto:shabanaishaq.work@gmail.com"
                className="btn-email"
              >
                Email Expert
              </a>
